...
class FaceController extends Controller
{
    ...
    {
        if ($code === 404) return 'Nenhum rosto cadastrado para este colaborador.';
        if (str_contains($raw, 'Nenhum rosto')) return 'Nenhum rosto detectado. Posicione o rosto no centro e tente novamente.';
        if (str_contains($raw, 'Mais de um rosto')) return 'Mais de um rosto na imagem. Certifique-se de estar sozinho.';
        return $raw;
    }
}
