...
class CompanyWebController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'notification_contact' => 'nullable|string|max:20',
        ...
        DB::transaction(function () use ($validated, $plainPassword, &$company) {
            $company = Company::create([
                ...
                'notification_contact' => $validated['notification_contact'] ?? null,
    ...
    public function update(Request $request, Company $company): RedirectResponse
    {
        ...
        $request->validate([
            ...
            'tolerance_mode' => 'required|string|in:daily_dead_band,daily_discount,clt_event_based,clt_event_strict',
        ...
        $company->update([
            ...
            'email' => $request->email,
            'phone' => $request->phone,
            'notification_contact' => $request->notification_contact ?: null,
