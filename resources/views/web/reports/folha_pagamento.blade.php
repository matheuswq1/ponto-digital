...
<form method="get" class="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 mb-6">
    ...
    <div class="flex items-center gap-3 mt-4 flex-wrap">
        ...
        @if(count($rows) > 0)
        {{-- Dropdown exportar --}}
        <div class="relative" id="export-dd-folha">
            <button type="button" onclick="toggleExportDd('folha')"
            ...
            <div id="export-menu-folha" class="hidden absolute left-0 mt-1 w-40 bg-white rounded-xl border border-slate-200 shadow-xl z-10 overflow-hidden">
