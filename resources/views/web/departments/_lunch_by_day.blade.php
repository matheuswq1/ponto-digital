...
@endphp
<div class="border border-slate-200 rounded-lg p-4 bg-slate-50/80">
    <p class="text-xs font-semibold text-slate-700 mb-1">Intervalo de almoço por dia</p>
    <p class="text-[11px] text-slate-500 mb-3">Use o <strong>intervalo padrão</strong> em cima como base. Ajuste abaixo apenas os dias em que o tempo for diferente (ex.: 90&nbsp;min num dia e 120&nbsp;min noutro).</p>
