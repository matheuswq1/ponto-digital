                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-medium text-slate-600 mb-1">
                            ...
                            <span class="ml-1 inline-flex items-center gap-1 text-emerald-600 font-semibold text-xs">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="notification_contact"
                                   value="{{ old('notification_contact', $company->notification_contact) }}"
                                   placeholder="11999999999" maxlength="20"
                        ...
                        <p class="text-xs text-slate-400 mt-1">Número que receberá alertas de novas solicitações de ponto via WhatsApp (somente dígitos, com DDD).</p>
                    </div>
                    <div class="sm:col-span-2">
